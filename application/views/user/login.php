...
<img class="login-bg" src="<?=base_url('assets/img/body_bg.jpg');?>">
    <main class="login-main d-flex flex-column h-100 align-items-center justify-content-center">
      <div class="login-form card">
        ...
        <form action="" method="post" name="login" class="card-body flex-column d-flex">
          ...
          <button class="w-100 btn btn-lg btn-primary" type="submit" value="login" name="login">Sign in</button>
        </form>
        <div class="pb-3 d-flex justify-content-center">
          <a href="<?=base_url('user/signup')?>">Register</a>
        </div>
      </div>
    </main>